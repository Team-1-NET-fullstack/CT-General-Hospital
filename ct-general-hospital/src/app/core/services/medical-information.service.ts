...
export class MedicalInformationService {
  ...
  addVitals(vitalSigns: VitalSigns) {
    this.http.post('http://localhost:3000/VitalSigns', vitalSigns).subscribe((res) => {
      console.log(res);
      this.loadData();
      console.log("data inserted success fully");
    });
  }
  addDiagnosisDetails(diagnosisDetails: DiagnosisDetails) {
    this.http.post('http://localhost:3000/DiagnosisDetails', diagnosisDetails).subscribe((res) => {
      console.log(res);
      this.loadData();
      console.log("data inserted success fully");
    });
  ...
  addProcedureDetails(procedureDetails: ProcedureDetails) {
    this.http.post('http://localhost:3000/ProcedureDetails', procedureDetails).subscribe((res) => {
      console.log(res);
      this.loadData();
      console.log("data inserted success fully");
    });
  ...
  addMedicationDetails(medicationDetails: MedicationDetails) {
    this.http.post('http://localhost:3000/MedicationDetails', medicationDetails).subscribe((res) => {
      console.log(res);
      this.loadData();
      console.log("data inserted success fully");
    });
  ...
  addPatientDetails(patientDetails:PatientDetails){
    this.http.post('http://localhost:3000/PatientDetails', patientDetails).subscribe((res) => {
      console.log(res);
      this.loadData();
      console.log("data inserted success fully");
    });
